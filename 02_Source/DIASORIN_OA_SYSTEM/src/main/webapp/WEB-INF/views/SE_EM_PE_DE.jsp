...
function updateEmployee(){
	...
	targetform.action = "${pageContext.request.contextPath}/SE_EM_PE_DE/updateEmployee?curPage="+curpage;
...
<form:form id="seEmPeDeAdBean" modelAttribute="seEmPeDeAdBean" commandName="seEmPeDeAdBean">
	<div class="position"><fmt:message key="se_em_pe_de_position" /></div>
	...
	<div class="list_main_box">
   	  <div class="list_title"><fmt:message key="se_em_pe_de_title" /></div> 
        <div class="list_box1">
        	<table border="0" cellpadding="0" cellspacing="0">
            	<tbody>
            		<tr>
                    	<td class="td_font" width="150px"><fmt:message key="se_em_pe_de_emNo" /></td>
                    	<td class="td_box"  width="362px">
                    		<form:input path="employeeNo" cssClass="input_date_box" disabled="true" maxlength="10"/>
                    	</td>
                        <td class="td_font" width="150px"><fmt:message key="se_em_pe_de_serCC" /></td>
                	...
                	<tr>
                    	<td class="td_font"><fmt:message key="se_em_pe_de_chiN" /></td>
                    	<td class="td_box">
                    		<form:input path="employeeNameCn" cssClass="input_date_box"/>
                    	</td>
                        <td class="td_font"><fmt:message key="se_em_pe_de_engN" /></td>
                    ...
                    <tr>
                        <td class="td_font"><fmt:message key="se_em_pe_de_costc" /></td>
                        <td class="td_box">
                        ...
                        <td class="td_font"><fmt:message key="se_em_pe_de_level" /></td>
                        <td class="td_box" colspan="2">   
                    ...
                    <tr>
                    	<td class="td_font"><fmt:message key="se_em_pe_de_role" /></td>
                    	<td class="td_box">
                    ...
                    <tr>
                    	<td class="td_font"><fmt:message key="se_em_pe_de_email" /></td>
                        <td class="td_box">
                    ...
                    <tr>
                    	<td class="td_font"><fmt:message key="se_em_pe_de_phone" /></td>
                    	<td class="td_box">
                    ...
                    <tr>
                    	<td class="td_font"><fmt:message key="se_em_pe_de_worlLoc" /></td>
                        <td class="td_box">
                    ...
                    <tr>
                    	<td class="td_font"><fmt:message key="se_em_pe_de_conAdd" /></td>
                    	<td class="td_box">
