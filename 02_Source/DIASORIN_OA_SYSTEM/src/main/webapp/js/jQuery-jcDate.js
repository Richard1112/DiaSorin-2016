...
;(function($){
	$.fn.jcDate = function(options) {
		...
		return this.each(function() {
			if($("#jcDate").length == 0){
				$("body").prepend("<div id='jcDate'><input type='hidden' value='' id='dateHideText' /><div id='jcDateTt'><a id='d_prev'></a><div><span></span><b> </b><samp></samp><b> </b></div><a id='d_next'></a></div><dl id='jcYeas'></dl><dl id='jcMonth'></dl><div id='jcDayWrap'><dl id='jcDayCon'></dl><div id='jcDateMax'><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul><ul></ul></div><div id='jcDateBtn'><samp>Today</samp><span>Clear</span><a id='d_sub'>Cfm</a><div id='jcTimeWrap'><input type='text' value='' /><label>:</label><input type='text' value='' /></div></div></div></div>");
			};
            ...
            var $dateInput = $(this),
				 ...
				 weekDl = "",
				 yearDl = "<dd class='visited'>"+_year+" "+"</dd>",
				 monthDl = "",
				 $ul = "",
				 _idx = 0,
				 defInfo = "",
			...
			for(var ms = 1; ms <= 12; ms++ ){
				if(ms == _month){
					mArr.push("<dt class='visited'>" + ms + " " +"</dt>");
				} else {
					mArr.push("<dt>" + ms + " " +"</dt>");
				};
			};
